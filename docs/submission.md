...
- The production callback fix is deployed. The [post-deployment callback verification](callback-after-deploy.json) passes: exact callback HTTP 201, spoofed hostname HTTP 400, no client secret issued.
